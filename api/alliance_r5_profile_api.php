<?php
/**
 * Alliance R5 Profile API
 * Allows R5s to update their Discord ID in alliances.json
 */
...
try {
    ...
    // Check if R5 exists
    if (!isset($alliances[$alliance_index]['r5'])) {
        throw new Exception('No R5 configured for this alliance');
    }

    // Update Discord ID
    $alliances[$alliance_index]['r5']['discordId'] = $discord_id;
